          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
            <div className="text-center mb-8">
              <div className="flex justify-center mb-4">
                <img src={logo} alt="AbhiAgri" className="h-14 w-14 object-contain rounded-full" />
              </div>
              <h1 className="text-xl font-bold text-foreground">{t("login.forgot_password")}</h1>
            ...
            <p className="text-center text-sm text-muted-foreground">
              <button onClick={() => setIsForgot(false)} className="font-semibold text-primary hover:underline">
                Back to login
              </button>
            </p>
          </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-md py-12 md:py-20">
        <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
          ...
          {/* Google Sign In */}
          <Button variant="outline" size="lg" className="w-full mb-4 gap-2" onClick={handleGoogleSignIn} disabled={loading}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <Input id="password" name="password" type={showPassword ? "text" : "password"} value={form.password} onChange={handleChange} placeholder="••••••••" required />
            ...
            <Button type="submit" size="lg" className="w-full" disabled={loading}>
              {loading ? "Please wait..." : isSignUp ? t("login.signup") : t("login.submit")}
            </Button>
          </form>
